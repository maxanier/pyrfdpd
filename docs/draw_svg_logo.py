...
fpath = str(Path.cwd() / "docs" / "pyrfdpd_logo.svg")

d = draw.Drawing(215, 80, origin=(0, 0), displayInline=False)

lettering = "pyrfdpd"
tlayer1 = draw.Text(
    lettering, 50, x=0, y=10, center=0.0, fill="#444444", font_family="FreightSansLFPro"
)
tlayer2 = draw.Text(
    lettering, 50, x=0, y=20, center=0.0, fill="#888888", font_family="FreightSansLFPro"
)
tlayer3 = draw.Text(
    lettering, 50, x=0, y=30, center=0.0, fill="#cccccc", font_family="FreightSansLFPro"
)
tlayer4 = draw.Text(
    lettering, 50, x=0, y=40, center=0.0, fill="#ee4c2c", font_family="FreightSansLFPro"
)

duration = "3s"
tlayer1.appendAnim(
    draw.Animate("y", duration, "-6;-16;-16;-6;", repeatCount="indefinite")
)
tlayer2.appendAnim(
    draw.Animate("y", duration, "-13;-18;-18;-13;", repeatCount="indefinite")
)
tlayer3.appendAnim(
    draw.Animate("y", duration, "-25;-20;-20;-25;", repeatCount="indefinite")
)
tlayer4.appendAnim(
    draw.Animate("y", duration, "-32;-22;-22;-32", repeatCount="indefinite")
)
